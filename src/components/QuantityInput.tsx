...
export default function QuantityInput({
  ...
  const styles = {
    sm: {
      button:
        "bg-slate-100 px-3 py-1.5 text-indigo-700 hover:bg-slate-200 disabled:text-gray-300 disabled:hover:bg-slate-100 transition-colors",
      input: "w-full bg-slate-100 py-1.5 text-center",
      container: "flex max-w-[120px] items-center font-bold",
    },
    lg: {
      button:
        "bg-slate-100 px-5 py-3 text-indigo-700 hover:bg-slate-200 disabled:text-gray-300 disabled:hover:bg-slate-100 transition-colors",
